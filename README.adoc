...
$ npm init
$ npm i -D typescript ts-loader tslint @types/react @types/react-dom @types/react-redux webpack webpack-cli webpack-dev-server clean-webpack-plugin html-webpack-plugin
$ npm i react react-dom redux react-redux redux-saga redux-starter-kit axios connected-react-router redux-actions
$ tsc --version
$ tsc --init
```
